...
namespace Nekres.RotationTrainer.Player
{
    internal class TemplatePlayer
    {
        ...
        {
            foreach (var binding in RotationTrainerModule.Instance.SkillBindings)
            {
        ...
        private async void DoRotation(string[] rotation, int skillIndex = 0, int repetitions = -1)
        {
            ...
            if (action.Equals("take") || action.Equals("interact")) {
                ...
                _currentKey = RotationTrainerModule.Instance.InteractionBinding.Value;
                ...
                _currentKey = RotationTrainerModule.Instance.DodgeBinding.Value;
                ...
                _currentKey = RotationTrainerModule.Instance.SkillBindings[skill].Value;
                ...
                hint = new Image
                {
                    ...
                    Texture = RotationTrainerModule.Instance.ContentsManager.GetTexture("skill_frame.png"),
                    Tint = Color.Red,
