...
namespace Nekres.RotationTrainer.Controls
{
    internal class TemplateButton : DetailsButton
    {
        ...
        private static Texture2D ClipboardSprite = RotationTrainerModule.Instance.ContentsManager.GetTexture("clipboard.png");
        private static Texture2D DividerSprite = GameService.Content.GetTexture("157218");
        private static Texture2D GlowClipboardSprite = RotationTrainerModule.Instance.ContentsManager.GetTexture("glow_clipboard.png");
        private static Texture2D GlowPlaySprite = RotationTrainerModule.Instance.ContentsManager.GetTexture("glow_play.png");
        private static Texture2D GlowUtilitySprite = RotationTrainerModule.Instance.ContentsManager.GetTexture("skill_frame.png");
        private static Texture2D IconBoxSprite = GameService.Content.GetTexture("controls/detailsbutton/605003");
        private static Texture2D PlaySprite = RotationTrainerModule.Instance.ContentsManager.GetTexture("play.png");
        private static Texture2D UtilitySprite = RotationTrainerModule.Instance.ContentsManager.GetTexture("skill_frame.png");
        ...
        protected override void OnClick(MouseEventArgs e)
        {
            ...
            else if (_mouseOverPlay)
            {
                ...
                RotationTrainerModule.Instance.Window.Hide();
            } 
        ...
        public override void PaintBeforeChildren(SpriteBatch spriteBatch, Rectangle bounds)
        {
            ...
            spriteBatch.DrawStringOnCtrl(this, Template.UtilityKeys[2].ToString(), Content.DefaultFont14, _utility3Bounds, Color.White, 
            ...
            spriteBatch.DrawStringOnCtrl(this, Template.UtilityKeys[1].ToString(), Content.DefaultFont14, _utility2Bounds, Color.White,
            ...
            spriteBatch.DrawStringOnCtrl(this, Template.UtilityKeys[0].ToString(), Content.DefaultFont14, _utility1Bounds, Color.White,
                false, true, 2, Blish_HUD.Controls.HorizontalAlignment.Center, VerticalAlignment.Bottom);
            ...
            // Wrap text
            var text = Text;
            var wrappedText = DrawUtil.WrapText(Content.DefaultFont14, text, SHEETBUTTON_WIDTH - 40 - iconSize - 20);
